...
if(isset($accessToken)){
    ...
    $output = '<a class="btn btn-block btn-dark text-white" href="'.htmlspecialchars($loginURL).'"  style="background:#000; color:white;"><i class="fab fa-github-circle"></i> Continue with github  </a>';
}
?>
<!doctype html>
